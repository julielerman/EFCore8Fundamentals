...
namespace PublisherData.Migrations
{
    ...
    [Migration("20231225142036_ComboAddresses")]
    partial class ComboAddresses
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PublisherDomain.Author", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Addresses", "PublisherDomain.Author.Addresses#Addresses", b1 =>
                        {
                            b1.IsRequired();

                            b1.ComplexProperty<Dictionary<string, object>>("HomeAddress", "PublisherDomain.Author.Addresses#Addresses.HomeAddress#Address", b2 =>
                                {
                                    b2.IsRequired();
                            ...
                            b1.ComplexProperty<Dictionary<string, object>>("ShippingAddress", "PublisherDomain.Author.Addresses#Addresses.ShippingAddress#Address", b2 =>
                                {
                                    b2.IsRequired();
